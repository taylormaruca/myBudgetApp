...
//let removeExpenseButton = document.querySelector('#remove_expense_button')
...
//let removeAmount = document.querySelector('#remove_amount');
//let removeInput = document.querySelector('#remove_input');
...
//removeExpenseButton.onclick = removeExpense;
...
//function removeExpense(event) {
    //event.preventDefault();
    //let expense = {
        //removeName: removeInput.value,
        //removeAmount: removeAmount.value
    //};
//}
